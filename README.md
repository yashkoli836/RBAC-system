...
To test user access use this -> curl -H "Authorization: Bearer your-token" http://localhost:3000/user
To test admin access use this-> curl -H "Authorization: Bearer your-token" http://localhost:3000/admin
